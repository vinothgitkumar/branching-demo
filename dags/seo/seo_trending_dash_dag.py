...
TRENDING_DASH_NOTEBOOK_PATH = SeoConfig.seo_trending_dash_notebook
...
data_load_params = {
    ...
    'notebook_task': {
        'notebook_path': TRENDING_DASH_NOTEBOOK_PATH,
        'base_parameters': {
